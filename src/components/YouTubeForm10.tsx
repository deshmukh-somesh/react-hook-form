...
// Video -> React Hook Form Tutorial - 16 - Numeric and Date Values
                    ...
                    <div>
                        {fields.map((field, index) => {
                            return (<div key={field.id}>
                                <input type='text' {...register(`phNumbers.${index}.number` as const)} className='mt-4' />
                                {index > 0 && (
                                    <button className='mt-4 bg-amber-700 border-amber-400 w-20 h-10 rounded-2xl' onClick={() => remove(index)}>
                                        Remove
                                    </button>
                                )}
                            </div>
                        ...
                        <button className='mt-4 bg-amber-700 border-amber-400 w-20 h-10 rounded-2xl' type='button' onClick={() => append({ number: "" })}>Add</button>
                    </div>
                </div>
